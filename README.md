...
```
DEVELOPED BY: KEERTHANA JAYSRI SK
REG NUM:212222110019
```
```
#include "main.h"
#include "lcd.h"
...
MX_GPIO_Init();
  ...
  Lcd_cursor(&lcd, 1,0);
  Lcd_string(&lcd, "Jayabharathi");

}
```

## Output screen shots of proteus  :
 ![image](https://github.com/keerthanajayasri/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/121163440/022f3c3b-c42d-4594-8126-11997e73f0a6)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/keerthanajayasri/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/121163440/2d14fdc6-f1ce-485e-8c98-ce18c86bcace)
